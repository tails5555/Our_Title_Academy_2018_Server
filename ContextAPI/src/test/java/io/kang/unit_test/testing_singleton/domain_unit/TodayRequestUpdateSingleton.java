...
public enum TodayRequestUpdateSingleton {
    INSTANCE;
    private TodayRequest todayRequest = new TodayRequest(1L, 1L, LocalDateTime.MIN);
    public TodayRequest getInstance(){
        if(this.todayRequest == null){
            return new TodayRequest(1L, 1L, LocalDateTime.MIN);
